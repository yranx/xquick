...
public class MyInitializer extends ChannelInitializer<SocketChannel>{
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        /**
         * LengthFiledPrepender: length属性在帧中的长度。只能为1，2，3，4，8.
         * 该值与对应的客户端（或者服务端）在解码的时候使用LengthFiedBasedFrameDecoder中所使用的
         * lengthFieldLength的值要保持一致
         */
